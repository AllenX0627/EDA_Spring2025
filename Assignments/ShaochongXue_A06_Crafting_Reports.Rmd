...
epa_metadata <- data.frame(
  ...
  Value = c("EPAair_O3_PM25_NC1819_Processed.csv", 
            "2018-2019", 
            "EPA Air Quality System (AQS)")
)

# kable
kable(epa_metadata, align = c("r", "l"), caption = "Table 1: EPA Air Quality")
```
...
```{r ozone_boxplot_2018,message=FALSE, warning=FALSE, echo=FALSE, fig.align='left', fig.height=3, fig.cap="Monthly Ozone concentrations (2018)"}
...
ggplot(ozone_2018, aes(x = factor(Month), y = Ozone)) +
  ...
  labs(title = "Figure 1: 2018 monthly Ozone levels", x = "Month", y = "Ozone (ppb)") +
  theme_minimal()
```

```{r ozone_boxplot_2019,message=FALSE, warning=FALSE, echo=FALSE, fig.align='left', fig.height=3, fig.cap="Monthly Ozone concentrations (2019)"}
...
ggplot(ozone_2019, aes(x = factor(Month), y = Ozone)) +
  geom_boxplot(fill = "lightblue", alpha = 0.7) +
  labs(title = "Figure 2: 2019 monthly Ozone levels", x = "Month", y = "Ozone (ppb)") +
  theme_minimal()
```
...
## Git Repository
https://github.com/AllenX0627/EDA_Spring2025.git
